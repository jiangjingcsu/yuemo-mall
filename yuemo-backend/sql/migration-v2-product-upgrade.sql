...
ALTER TABLE `yu_cart_item` ADD COLUMN `sku_id` BIGINT DEFAULT NULL COMMENT 'SKU ID' AFTER `product_id`;
ALTER TABLE `yu_cart_item` ADD COLUMN `spec_text` VARCHAR(128) DEFAULT NULL COMMENT '规格文本' AFTER `sku_id`;
